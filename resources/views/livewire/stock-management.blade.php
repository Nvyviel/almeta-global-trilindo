<div class="container mx-auto px-4 py-12 max-w-3xl">
    ...
    <div class="bg-white rounded-xl border border-gray-200 shadow-lg overflow-hidden">
        ...
        {{-- Total Stock Display --}}
        <div class="p-8">
            <div class="bg-gray-50 rounded-xl p-6 space-y-4 border border-gray-200 text-center mb-8">
            ...
            <form wire:submit.prevent="save" class="mb-8">
                ...
                <button type="submit"
                    class="mt-4 w-full px-8 py-3.5 bg-blue-600 hover:bg-blue-700 text-white rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 transition-all duration-200 flex items-center justify-center">
