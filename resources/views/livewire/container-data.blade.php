    ...
    <form wire:submit.prevent="addContainer" class="max-w-7xl mx-auto space-y-6">
        ...
        <div class="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden">
            <div class="border-b border-gray-200 bg-gray-50 px-6 py-4">
                <h1 class="text-xl font-semibold text-gray-900">Shipment Information</h1>
            </div>
            <div class="p-6">
        ...
        <div class="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden">
            <div class="border-b border-gray-200 bg-gray-50 px-6 py-4">
                <h1 class="text-xl font-semibold text-gray-900">Container Details</h1>
            </div>
            <div class="p-6">
        ...
        <div class="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden">
            <div class="p-6">
                <div class="flex items-start space-x-4">
                    <div class="flex-shrink-0">
                        <i class="fa-solid fa-skull-crossbones text-4xl text-red-500"></i>
                    </div>
