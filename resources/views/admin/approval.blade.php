        ...
        <div class="container mx-auto px-4">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-8 max-w-7xl mx-auto">
                ...
                <div class="bg-white rounded-xl shadow-sm hover:shadow-xl transition-all duration-300 p-8 flex flex-col h-full border border-gray-100">
                    ...
                    <div class="mt-auto">
                        <a href="{{ route('create-bill') }}" wire:navigate class="inline-flex items-center justify-center px-6 py-3 border border-transparent text-base font-medium rounded-md text-white bg-orange-600 hover:bg-orange-700 transition-colors duration-300 w-full sm:w-auto">
                            Manage BL
                            <i class="fa-solid fa-arrow-right-long ml-2"></i>
                        </a>
                    </div>
