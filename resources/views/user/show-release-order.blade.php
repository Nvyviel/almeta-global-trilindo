    ...
    <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="bg-white rounded-lg shadow-sm p-6 mb-8">
            <div class="flex items-center justify-between">
                ...
                <span class="px-4 py-2 rounded-full text-sm font-semibold {{ 
                    $container->status == 'Requested' ? 'bg-yellow-100 text-yellow-700' : 
                    ($container->status == 'Approved' ? 'bg-green-100 text-green-700' : 'bg-red-100 text-red-700') 
                }}">
                    {{ $container->status }}
                </span>
            </div>
        ...
        <div class="bg-white rounded-lg shadow-sm p-6 mb-8">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
                ...
                <div class="bg-gray-50 rounded-lg p-4">
                    <div class="flex items-center">
                        <div class="p-3 rounded-full {{ $container->is_danger === 'Yes' ? 'bg-red-100 text-red-600' : 'bg-green-100 text-green-600' }}">
                            <i class="fa-solid {{ $container->is_danger === 'Yes' ? 'fa-triangle-exclamation' : 'fa-circle-check' }}"></i>
                        </div>
                        <div class="ml-4">
                            <p class="text-sm text-gray-500">Danger Status</p>
                            <p class="text-lg font-semibold text-gray-900">{{ $container->is_danger ? 'No': 'Yes' }}</p>
                        </div>
                    </div>
                </div>
            </div>
