    ...
    <div class="max-w-7xl mx-auto py-8 px-4 sm:px-6 lg:px-8">
        ...
        <div class="flex justify-between items-center mb-6">
            ...
            <a href="{{ route('create-bill') }}" wire:navigate
                class="px-4 py-2 bg-indigo-600 text-white rounded-lg shadow hover:bg-indigo-700 transition-all duration-200">
                + Create Bill
            </a>
        </div>
        ...
        @if (session()->has('success'))
            <div class="bg-green-100 border border-green-400 text-green-700 px-6 py-4 rounded-lg shadow-sm mb-6" role="alert">
        ...
        <div class="mb-6">
            <div class="flex flex-wrap gap-2 justify-center md:justify-start">
                <a href="{{ route('bill-of-lading', ['filter' => 'all']) }}" wire:navigate
                ...
                <a href="{{ route('bill-of-lading', ['filter' => 'paid']) }}" wire:navigate
                    class="px-4 py-2 rounded-full text-sm font-medium transition-all {{ request('filter') === 'paid' ? 'bg-green-600 text-white' : 'bg-gray-100 text-gray-600 hover:bg-gray-200' }}">
                    Paid
                </a>
                <a href="{{ route('bill-of-lading', ['filter' => 'unpaid']) }}" wire:navigate
                    class="px-4 py-2 rounded-full text-sm font-medium transition-all {{ request('filter') === 'unpaid' ? 'bg-yellow-500 text-white' : 'bg-gray-100 text-gray-600 hover:bg-gray-200' }}">
                    Unpaid
                </a>
            </div>
        </div>
                            ...
                            <div class="flex items-center space-x-3">
                                ...
                                <div class="flex items-center space-x-2">
                                    @php
                                        ...
                                        $statusClass = $statusClasses[$bill->status] ?? 'bg-gray-100 text-gray-800 border-gray-200';
                                    @endphp
